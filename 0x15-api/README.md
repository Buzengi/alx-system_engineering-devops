...
This project was further practice in working with API's. Data collected from the
[JSONPlaceholder REST API](https://jsonplaceholder.typicode.com/), and acquainted on how
