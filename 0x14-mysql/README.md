...
This project is aimed at learning how to configure database servers in a
primary-replica model. Two servers provided will be configured in a MySQL primary-replica setup with a dummy database,
A Bash script is written to automate generation of database backups.
